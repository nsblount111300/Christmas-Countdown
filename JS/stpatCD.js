...
const stpat = new Date("03/17/2024");
...
function stPatricksCountdown() {
  const today = new Date();
  const timeSpan = stpat - today;
  ...
  if (timeSpan <= 0) {
    title.innerHTML = "Happy St. Patrick's Day!";
    daysLeft.innerHTML = "Hope you have a lucky day!";
    hoursLeft.innerHTML = "";
...
timerId = setInterval(stPatricksCountdown, second);
